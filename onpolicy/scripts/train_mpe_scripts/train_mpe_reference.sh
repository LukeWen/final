...
do
    ...
    --n_training_threads 1 --n_rollout_threads 16 --num_mini_batch 1 --episode_length 12 --num_env_steps 300 \
    --ppo_epoch 15 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "xxx" --user_name "lukewen"
done
...
#     --ppo_epoch 15 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "xxx" --user_name {Your wandb username}
# done